...
func TestEvent(t *testing.T) {
	...
	Subscrib("tag1", event1, func(e interface{}, args ...interface{}) {
		t.Logf("tag1, event: %v, args: %v", e, args)
	})

	SubscribOnce("tag2", event1, func(e interface{}, args ...interface{}) {
		t.Logf("tag2, event: %v, args: %v", e, args)
	})

	Subscrib("tag3", event2, func(e interface{}, args ...interface{}) {
		t.Logf("tag3, event: %v, args: %v", e, args)
	})

	Subscrib("tag_all", EventAll, func(e interface{}, args ...interface{}) {
